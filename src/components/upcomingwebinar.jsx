    ...
    <section className="overflow-hidden bg-cover bg-top bg-no-repeat pt-12 bg-[url(https://lenscorp.ai/_next/static/media/Gradient_bg_section4.71fb66b2.jpg)]">
      ...
      <div className="flex flex-col items-center">
        {courses?.slice(0, 3).map((course) => (
          <div
            key={course?.courseID}
            className="text-black center px-4 py-4 sm:px-4 sm:py-6 lg:px-4 lg:py-4 border-2 border-[#ff5d5b] rounded-xl mb-8 mt-4 lg:w-[70%] w-full mx-auto transform transition-transform duration-300 ease-in-out hover:scale-105"
          >
